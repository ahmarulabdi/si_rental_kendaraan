<div class="col-sm-12 ">
   <div class="panel panel-success box-shadow">
     ...
     <div class="panel-body">
        ...
        <?php if ($hak_akses == 'administrator'):?>
        <p>
            <a href="#" class="btn btn-success" data-target="#ModalAddPengguna" data-toggle="modal">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                  ...
                  <tr>
                     ...
                     <?php if(($hak_akses == 'manager')&&($r['hak_akses'] == 'pelanggan')): ?>
                        <?php
                        $query =$Pelanggan."where username ='".$r['username']."'";
                        $cek = mysqli_query($conn,$query);
                        if ($cek) :?>
                           <td>
                              <span class="label label-lg label-warning" data-rel="popover" data-placement="bottom" title="Tidak Terdaftar"
                              data-content='Pengguna dengan Username <span class="red"><?php echo $r['username']?></span>
                              berikut tidak terdaftar sebagai Pelanggan<br/><br/>
                              <a href="?user=pelanggan&username=<?php echo $r['username']; ?>">
                  					Tambah Sebagai Pelanggan ?
                  				</a>
                              '>
                              <i class="ace-icon fa fa-exclamation-triangle bigger-120"></i> <?php echo $r['hak_akses']; ?>
                              </span>
